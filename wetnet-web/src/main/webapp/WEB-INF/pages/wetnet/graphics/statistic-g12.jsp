...
<body ng-controller="WetnetControllerG12">
    ...
    <div class="row">
        <div class="col-md-6">
			<label ng-show="columns.length > 0"><spring:message code="statistic-g12.graph.time-series-chart"/></label>
            <div class="row chart-wrap">
                <div id="time-series-chart" build-chart></div>
            </div>
        </div>
        <div class="col-md-6">
			<label ng-show="columns.length > 0"><spring:message code="statistic-g12.graph.seasonal-chart"/></label>
			<div class="row chart-wrap">
    ...
    <div class="row">
		<div class="col-md-6">
			<label ng-show="columns.length > 0"><spring:message code="statistic-g12.graph.trend-chart"/></label>
			<div class="row chart-wrap">
				<div id="trend-chart" build-chart></div>
			</div>			
		</div>
		<div class="col-md-6">
			<label ng-show="columns.length > 0"><spring:message code="statistic-g12.graph.residue-chart"/></label>
			<div class="row chart-wrap">
