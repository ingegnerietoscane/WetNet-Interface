 ...
 */
@XmlRootElement
public class MeasuresFiles implements Comparable<MeasuresFiles> {
    ...
    @XmlAttribute(required = false)
    private int idMeasures;
   
	@Override
	public int compareTo(MeasuresFiles o) {
	...
	public int getIdMeasures() {
		return idMeasures;
	}

	public void setIdMeasures(int idMeasures) {
